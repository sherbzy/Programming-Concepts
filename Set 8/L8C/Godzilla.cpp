...
//write a greet function that accepts another godzilla as a parameter which is passed by constant reference
void Godzilla::greet (const Godzilla target) {
    cout << godzillaName << " bows to " << target.godzillaName << "." << endl;
}
